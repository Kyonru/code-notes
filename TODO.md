...
- [x] **Note templates** — Predefined templates (e.g., "Bug Investigation", "Code Review", "Feature Exploration") with starter headings
...
- [x] **Note comments/threads** — Allow multiple annotations per reference, creating a conversation thread
